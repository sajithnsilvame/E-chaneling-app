        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
             <div class="form-group">
                ...
                @endif
                           <form class="form-horizontal" action="{{url('add_doctor')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                              <div class="card-body">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" value="Dr. " placeholder="Name Here" required/>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control" name="mobile_number" maxlength="10" placeholder="Mobile Number" required/>
                                 </div>
                              </div>

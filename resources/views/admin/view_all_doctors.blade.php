                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tbody>
                        @foreach ($doctors as $doc_list)
                          <tr>
                            <td>{{$doc_list->id}}</td>
                            <td>{{$doc_list->name}}</td>
                            <td>{{$doc_list->contact}}</td>
                            <td>{{$doc_list->specialization}}</td>
                            <td>
                              <a href="{{url('edit-doctor-info', $doc_list->id)}}" class="btn btn-primary">Edit</a>
                            </td>
                            <td>
                              <a href="{{url('delete-doctor', $doc_list->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                            </td>
                          </tr>
                        @endforeach

      ...
      <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
             <div class="form-group">
                ...
                @endif
                           <form class="form-horizontal" action="{{url('add-drugs')}}" method="POST" >
                                @csrf
                              <div class="card-body">
                              <h4 class="card-title">Enter the Drug Details</h4>

                              <div class="form-group row">
                                 <label class="col-sm-3 text-end control-label col-form-label"> Drug Name</label>
                                 <div class="col-sm-9">
                              ...
                              <div class="form-group row">
                                 <label class="col-sm-3 text-end control-label col-form-label">Drug Price</label>
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control" name="drug_price" placeholder="Drug Price" required/>
                                 </div>
                              </div>
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">All Drug Details</h5>
